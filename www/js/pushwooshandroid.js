...
function initPushwoosh() {
  ...
  //register for pushes 1. first time install 2. Push notification setting on
  if( angular.isUndefined(window.localStorage.Pushwoosh) || window.localStorage.Pushwoosh === "true" ){
